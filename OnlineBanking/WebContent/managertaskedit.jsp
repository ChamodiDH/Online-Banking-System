...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinebank", "root", "123qwebnm");
String query = "select * from task where staffId='"+staffId+"'";
...
<tr>
<td>StaffID</td>
<td><input type="text" name="staffId" value="<%=rs.getString("staffId")%>" readonly></td>
</tr>
...
<tr>
<td>Duty</td>
<td><input type="text" name="duty" value="<%=rs.getString("duty")%>"></td>
</tr>


<tr>
<td></td>
<td><input type="submit" name="submit" value="Update" class ="myButton2"></td>
</tr>
<%
}
}
